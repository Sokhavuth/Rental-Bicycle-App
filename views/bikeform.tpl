...
<div class="main" id="main">
  <div class="content" id="content">
    ...
    <form id="bikeform" method="POST" action="/bikeform" onsubmit="return bicycle.bicycleForm('bikeform')">
      <a>Brand:</a><input name="fbrand" value="{{data['rowedit'][1]}}" type="text" required />
      <a>Country:</a><input name="fcountry" value="{{data['rowedit'][2]}}" type="text" required />
      <a>Year:</a><input name="fyear" value="{{data['rowedit'][3]}}" type="text" required />
      <a>Amount:</a><input name="famount" value="{{data['rowedit'][4]}}" type="text" required />
      <a>Price:</a><input name="fprice" value="{{data['rowedit'][5]}}" type="text" required />
